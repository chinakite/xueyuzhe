  ...
  <body>
    ...
    <script id="secListTmpl" type="text/html">
        {{each seclist as sec idx}}
            <li class="table-view-cell table-cell-view-section light-border f20"><span class="f14">{{sec.name}}</span><i class="fa fa-play-circle-o pull-right text-green" onclick="playaudio('{{sec.audioes[0].audioUrl}}')"></i></li>
        {{/each}}
    </script>
